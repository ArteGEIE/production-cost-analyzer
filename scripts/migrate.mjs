// Standalone migration runner for the deployed container: run it before the new
// version starts, from whatever orchestrates your deployment (a Compose service,
// an init step, a one-off job).
//
...
// the environment — no dotenv here.
...
// `[migrate] failed:` marker — harder to spot in a job's logs.
